...
void WGraphicsWidget::iniPanel()
{
    ...
    for (int i = 0; i < d->m_btnsObjName.count(); i++) {
        ...
        //QString str = QString("D:/project/Qt/pluginapp/FrameWork/graphics/image/%1.png").arg(d->m_btnsObjName[i]);

        //QString str = QString(":/icons/image/%1.png").arg(d->m_btnsObjName[i]);
