...
#define H_ERR_LAST_LIC_ERROR H_ERR_LIC_PREVIEW_EXPIRED
...
#define H_ERR_CNN_INVALID_INPUT_DEPTH    7724 /* New number of channels must be 
                                                 either 1 or 3. */
#define H_ERR_CNN_DEPTH_NOT_AVAILABLE    7725 /* New input number of channles 
...
#define H_ERR_CNNGRAPH_IO_INVALID     7761 /* HCNNGraph: Invalid data
                                              serialization */
#define H_ERR_CNNGRAPH_LAYER_INVALID  7762 /* HCNNGraph: Invalid layer type */
...
#define H_ERR_CNNGRAPH_ARCH_NOT_SUITABLE  7774 /* CNN-Graph: Architecture not
                                              suitable for the adaption of the
