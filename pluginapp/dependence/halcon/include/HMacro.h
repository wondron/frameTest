...
#define HRealloc(PROC_HANDLE,VOID_PTR,SIZE,NEW_PTR)                     \
  HXRealloc(PROC_HANDLE,(VOIDP)(VOID_PTR),SIZE,(VOIDP)(NEW_PTR),        \
            H__FILE__,(INT4_8)H__LINE__)
...
#define HAllocTmp(PROC_HANDLE,PTR,SIZE)                                 \
  HXAllocTmp(PROC_HANDLE,(VOIDP)(PTR),SIZE,H__FILE__,(INT4_8)H__LINE__)

#define HAllocTmpAlign(PROC_HANDLE,PTR,SIZE,ALIGNMENT)          \
  HXAllocTmpAlign(PROC_HANDLE,(VOIDP)(PTR),SIZE,ALIGNMENT,      \
                  H__FILE__,(INT4_8)H__LINE__)
...
#define HFreeTmp(PROC_HANDLE,VOID_PTR)                                  \
  HXFreeTmp(PROC_HANDLE,(VOIDP)(VOID_PTR),H__FILE__,(INT4_8)H__LINE__)
...
#define HFreeUpToTmp(PROC_HANDLE,VOID_PTR)                              \
  HXFreeUpToTmp(PROC_HANDLE,(VOIDP)(VOID_PTR),H__FILE__,(INT4_8)H__LINE__)

#define HFreeUpToTmpExcl(PROC_HANDLE,VOID_PTR)                          \
  HXFreeUpToTmpExcl(PROC_HANDLE,(VOIDP)(VOID_PTR),H__FILE__,(INT4_8)H__LINE__)
...
#define HAllocLocal(PROC_HANDLE,SIZE,VOID_PTR) \
  HXAllocLocal(PROC_HANDLE,SIZE,H__FILE__,(INT4_8)H__LINE__,(VOIDP)(VOID_PTR))
...
#define HAllocLocalGC(PROC_HANDLE, SIZE, VOID_PTR)                            \
  HXAllocLocalGC(PROC_HANDLE,SIZE,H__FILE__,(INT4_8)H__LINE__,(VOIDP)(VOID_PTR))
...
#define HFreeLocal(PROC_HANDLE,VOID_PTR)                                \
  HXFreeLocal(PROC_HANDLE,(VOIDP)(VOID_PTR),H__FILE__,(INT4_8)H__LINE__)
