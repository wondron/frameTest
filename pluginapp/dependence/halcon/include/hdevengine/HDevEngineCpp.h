...
public:
  ...
  //  "mem_free_intern" [default: true]
  //    - clean the HDevOperatorImpl instance if SetHDevOperatorImpl(NULL)
  //      is called or if the instance of the HDevEngine is destroyed. 
  //      Cleaning it manually again throws an exception
  //    - if set to false do not clean up 
  //      the HDevOperatorImpl instance automatically,  
  //      user has to do it manually to avoid memory leak
