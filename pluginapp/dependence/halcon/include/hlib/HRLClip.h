...
extern HLibExport Herror HRLClipp2(Hproc_handle proc_id,
                                   Hrlregion *in_out, HINT l1, HINT c1,
                                   HINT l2, HINT c2);


extern HLibExport Herror HRLRelClipp(Hproc_handle proc_id,
                                     Hrlregion *region, HINT top, HINT bottom,
                                     HINT left, HINT right, Hrlregion *clipped);
