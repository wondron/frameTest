...
extern HLibExport Herror HPGetOutpObj(Hproc_handle proc_handle,
...
extern HLibExport Herror HPGetPar(Hproc_handle proc_handle,
                                  HINT par_num, HINT kind_in, HINT *kind,
...
extern HLibExport Herror HPGetCPar(Hproc_handle proc_handle,
                                   HINT par_num, HINT kind_in, Hcpar Val[],
...
extern HLibExport Herror HPPutCPar(Hproc_handle proc_handle,
                                   HINT par_num, Hcpar  *Val, INT4_8 num);
...
extern HLibExport Herror HPNumOfChannels(Hproc_handle proc_handle,
                                         HINT par_num,
                                         INT4_8 obj_num,HINT *chn_num);

/* HPCrXLD - create XLD object                                               */
extern HLibExport Herror HPCrXLD(Hproc_handle proc_handle, HINT Par, VOIDP XLD,
...
extern HLibExport Herror
HPAllocOutpCtrl( Hproc_handle ph, HINT par, HINT type, INT4_8 length,
                 void*H_RESTRICT* elem);
#define HAllocOutpCtrl(ph,par,type,length,elem)           \
  HPAllocOutpCtrl( ph, par, type, length, (void*H_RESTRICT*) elem)

extern HLibExport Herror
HFreeOutpCtrl( Hproc_handle ph, HINT par);

extern HLibExport Herror
HPReallocOutpCtrl( Hproc_handle ph, HINT par, HINT newtype, INT4_8 newlength,
                  void*H_RESTRICT* elem);
...
HSetNumOutpCtrl( Hproc_handle ph, HINT par, INT4_8 num);

extern HLibExport void
HPGetPElem( Hproc_handle ph, HINT par,
            void const*H_RESTRICT*elem, INT4_8 *num, HINT *type) ;
...
extern HLibExport Herror
HPGetPElemL( Hproc_handle ph, HINT par, HINT convert,
             INT4_8 const*H_RESTRICT*elem, INT4_8 *num) ;
extern HLibExport Herror
HPGetPElemD( Hproc_handle ph, HINT par, HINT convert,
             double const*H_RESTRICT*elem, INT4_8 *num) ;
extern HLibExport Herror
HPGetPElemS( Hproc_handle ph, HINT par, HINT convert,
             char const* const*H_RESTRICT*elem, INT4_8 *num) ;
extern HLibExport Herror
HPGetPElemH( Hproc_handle ph, HINT par, const HHandleInfo *expected_type,
             INT4_8 expected_num, void **elem, INT4_8 *num, HBOOL alloc);

/* copy variant */
extern HLibExport Herror
HPGetElemL( Hproc_handle ph, HINT par, HINT convert, HINT memtype,
            INT4_8 *H_RESTRICT*elem, INT4_8 *num);
extern HLibExport Herror
HPGetElemD( Hproc_handle ph, HINT par, HINT convert, HINT memtype,
            double *H_RESTRICT*elem, INT4_8 *num);
extern HLibExport Herror
HPGetElemS( Hproc_handle ph, HINT par, HINT convert, HINT memtype,
            char  *H_RESTRICT*H_RESTRICT *elem, INT4_8 *num);

/* copy variant with preallocated arrays */
extern HLibExport Herror
HPCopyElemL( Hproc_handle ph, HINT par, HINT convert,
             INT4_8 *H_RESTRICT lelem, INT4_8 *num);
extern HLibExport Herror
HPCopyElemD( Hproc_handle ph, HINT par, HINT convert,
             double *H_RESTRICT delem, INT4_8 *num);
extern HLibExport Herror
HPCopyElemF( Hproc_handle ph, HINT par, HINT convert,
             float *H_RESTRICT delem, INT4_8 *num);

/* returning handles */
extern HLibExport Herror
HAllocOutputHandles( Hproc_handle ph, HINT parnr, Hphandle **elem, INT4_8 num,
                     const HHandleInfo *type);
extern HLibExport Herror
HXAllocOutputHandle( Hproc_handle ph, HINT parnr, void ***elem,
                     const HHandleInfo *type);
