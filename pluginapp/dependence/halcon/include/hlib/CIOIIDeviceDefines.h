...
#define HIOGET_IOII_HMAJOR(IOI_VERSION)    (HIOGET_IOII_VERSION(IOI_VERSION)/100)
#define HIOGET_IOII_HMINOR(IOI_VERSION)    (HIOGET_IOII_VERSION(IOI_VERSION)%100)
...
typedef struct _HIOClass {
  ...
  Hphandle hioclass;                /* back reference to the actual HALCON
                                     * handle */
