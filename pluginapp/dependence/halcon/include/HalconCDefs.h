...
#define     HALCON_C_VERS             "18.05"
#define     HALCON_C_LAST_UPDATE      "18.05.2018"
...
LIntExport void   Mset_s_len(Htuple* t, Hlong len, Hlong i,
                              char const* file, int line);
LIntExport void   Mset_h(Htuple* t, Hphandle v, Hlong i,
                          const char* file, int line);
...
LIntExport void   Mcreate_tuple_s(Htuple* t, char const* value,
                                  char const* file, int line);
LIntExport void   Mcreate_tuple_h(Htuple* t, Hphandle value,
                                  char const* file, int line);
...
LIntExport void   Mreuse_tuple_s(Htuple* t, char const* value,
                                 char const* file, int line);
LIntExport void   Mreuse_tuple_h(Htuple* t, Hphandle value,
                                 char const* file, int line);
...
LIntExport void   F_init_h(Htuple*H_RESTRICT t, Hphandle value,
                           Hlong idx);
...
#define at_h(TUP,IDX)          ((char const*const)((HANDLE_PAR==(TUP).type)? \
                                      (TUP).elem.h[IDX] :                    \
                                      /*MIXED_PAR*/ (TUP).elem.cpar[IDX].par.h)
...
#define init_s_len(TUP,LEN,IDX)  Mset_s_len(&(TUP),LEN,IDX,  \
                                            __FILE__,__LINE__)
#define init_h(TUP,VAL,IDX)      Mset_h(&(TUP),VAL,IDX,  \
                                        __FILE__,__LINE__)
...
#define set_s(TUP,VAL,IDX)       Mset_s(&(TUP),VAL,IDX,  \
                                        __FILE__,__LINE__)
#define set_h(TUP,VAL,IDX)       Mset_h(&(TUP),VAL,IDX,  \
                                        __FILE__,__LINE__)
...
#define get_s(TUP,IDX)           Mget_s(&(TUP),IDX,  \
                                        __FILE__,__LINE__)
#define get_h(TUP,IDX)           Mget_h(&(TUP),IDX,  \
                                        __FILE__,__LINE__)
...
#define at_s(TUP,IDX)            Mget_s(&(TUP),IDX,  \
                                        __FILE__,__LINE__)
#define at_h(TUP,IDX)            Mget_h(&(TUP),IDX,  \
                                        __FILE__,__LINE__)
...
#define create_tuple_h(TUP,VAL)  Mcreate_tuple_h(TUP,VAL,__FILE__,__LINE__)
